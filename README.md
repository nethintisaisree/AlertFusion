...
| Arjun Reddy | 9000011122 | Kukatpally, Lane 4 | Crime | I saw two people arguing loudly outside my window it looked like it could become a fight | `REVIEW_REQUIRED` |
| Sneha Patel | 9988776655 | Banjara Hills | Other | I heard some strange sounds from the locked room next door not sure what is happening | `LOG_AND_MONITOR` |
| Kritika Rathore | 9870982345 | Begumpet | Medical | lol not an emergency just testing | `SUSPECTED_MISUSE` |
